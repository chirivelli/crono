...
export function MobileNavigationBar() {
  ...
  return (
    <View className="border-t border-gray-200 bg-white px-3 pb-3 pt-2">
        ...
        {items.map(item => {
          ...
          return (
            <Link key={item.href} href={item.href} asChild>
              <Pressable className={active ? 'min-w-24 items-center gap-1 rounded-full bg-gray-100 px-4 py-2' : 'min-w-20 items-center gap-1 rounded-full px-4 py-2'}>
